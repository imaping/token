...
import io.github.imaping.token.configuration.model.attachment.AttachmentProperties;
import io.github.imaping.token.configuration.model.cas.CasProperties;
import io.github.imaping.token.configuration.model.district.DistrictProperties;
import io.github.imaping.token.configuration.model.elasticsearch.ElasticSearchProperties;
import io.github.imaping.token.configuration.model.token.CaptchaProperties;
import io.github.imaping.token.configuration.model.token.CloudProperties;
import io.github.imaping.token.configuration.model.token.TokenConfigurationProperties;
import io.github.imaping.token.configuration.model.user.UserProperties;
